...
public class BrowseItemFocusHighlight {
    ...
    private BrowseItemFocusHighlight(int zoomIndex, boolean useDimmer) {
...
//            mView.setPivotY(mView.getHeight()/2);
     ...
     * No zoom factor.
     */
    private static final int ZOOM_FACTOR_NONE = 0;

    /**
     * A small zoom factor, recommended for large item views.
     */
    private static final int ZOOM_FACTOR_SMALL = 1;

    /**
     * A medium zoom factor, recommended for medium sized item views.
     */
    private static final int ZOOM_FACTOR_MEDIUM = 2;

    /**
     * A large zoom factor, recommended for small item views.
     */
    private static final int ZOOM_FACTOR_LARGE = 3;

    /**
     * An extra small zoom factor.
     */
    private static final int ZOOM_FACTOR_XSMALL = 4;
}
