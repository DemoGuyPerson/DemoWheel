 ...
 *
 * @author liuqz
 * @see AbsAdapterPresenter#isUseNomalRecyclerView()
 * @see AbsAdapterPresenter#isUseCustomLayoutManager()
 */
    ...
    public View focusSearch(View focused, int direction) {
        ...
        if (direction == FOCUS_UP ){
            if (focused instanceof HRecyclerViewItemViewCallback) {
                ...
                LogX.d(TAG+" focusSearch mFocusCallBack != null : "+(mFocusCallBack != null)+" itemLayout.getPosition() : "+hRecyclerViewItemViewCallback.getParentPosition());
                if (hRecyclerViewItemViewCallback.getParentPosition() == 0 && mFocusCallBack != null) {
                    View nextView = mFocusCallBack.getNextFocusView();
            ...
            if (isFocusNomal()){
                if (focused instanceof HRecyclerViewItemViewCallback) {
                    HRecyclerViewItemViewCallback hRecyclerViewItemViewCallback = (HRecyclerViewItemViewCallback) focused;
                    if (hRecyclerViewItemViewCallback.isLastPosition()){
                        return focused;
                    }
                }
            }else if (isFocusStart()){
...
//                                    && focusedItemView.getHomeType() == nextItemView.getHomeType()) {
                            changeStartPosition(recyclerViewItemViewCallback.isFirstPosition());
...
//                            }
            ...
            if (isFocusNomal()) {
                if (focused instanceof HRecyclerViewItemViewCallback) {
                    HRecyclerViewItemViewCallback hRecyclerViewItemViewCallback = (HRecyclerViewItemViewCallback) focused;
                    if (hRecyclerViewItemViewCallback.isFirstPosition()){
                        return focused;
                    }
                }
            }else if (isFocusStart()){
