package com.nes.customgooglelauncher.bean.notifications;
...
public class TvNotification {
    ...
    public String toString() {
        return "TvNotification{" +
                ...
                ", mIsOngoing=" + mIsOngoing +
                ", mSmallIcon=" + mSmallIcon +
                ", mChannel=" + mChannel +
                ", mProgress=" + mProgress +
                ", mProgressMax=" + mProgressMax +
                ", mHasContentIntent=" + mHasContentIntent +
                ", mBigPicture=" + mBigPicture +
                ", mContentButtonLabel='" + mContentButtonLabel + '\'' +
                ", mDismissButtonLabel='" + mDismissButtonLabel + '\'' +
                ", mTag='" + mTag + '\'' +
                '}';
    }
}
